...
{
	// Accordance between Network and Local name
	mCharName = name;
	networkName = name;

	// Set the collision type for the object
	...
	// Set the object scale, in the node
...
/*
	The init method can be useful in network games, after a default constructor
*/
...
void RenderableChar::update(float dtime)
{
	if (mMainNode != NULL) {
		...
		// Update velocities taking friction into account
...
{
	// If below I have a block, set Y vel to 0
	...
	// Otherwis, I have killed a player!
